...
Flash `rk356x_spl_loader_v1.13.112.bin` and `uboot.img` to your SD card / eMMC. Details can be found on the pine64 wiki [here](https://wiki.pine64.org/wiki/Quartz64_Development#Bootloader_Flashing) and [here](https://wiki.pine64.org/wiki/Installing_Debian_on_the_Quartz64), but here's a five-second howto:
...
sudo dd if=rk356x_spl_loader_v1.13.112.bin of="${sd_path}p1" bs=64K
